...
#include "BTTaskNode_GetNextRandomPointTo.generated.h"

/**
 * 
 */
UCLASS(Config=Game)
class FALLENCORSAIR_API UBTTaskNode_GetNextRandomPointTo : public UBTTaskNode
{
	GENERATED_BODY()

	UBTTaskNode_GetNextRandomPointTo(const FObjectInitializer& ObjectInitializer);
